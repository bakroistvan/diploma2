...
\centering
	...
	\subfloat[A kamera beállításainak és a képének megjelenítésére alkalmas tool.]{
		\includegraphics[width=0.95\columnwidth]{figures/vimbaviewer.png}
		\label{fig:cam_sw}
	}
...
%----------------------------------------------------------------------------
	...
	kísérletek során az ezirányú mozgása a részecskéknek nem számottevő, így ez elhanyagolásra kerül.
	A részecske $x-y$ pozícióját jól lehet számítani a kép alapján. Nagy pontosság esetén szükséges a képek előzetes feldolgozása a
	...
	A kísérlet során fontos ismerni a részecskék pontos helyzetét és a részecske-rendszer eloszlás eloszlásfüggvényét. Az eloszlás
	alatt természetesen a tapasztalati eloszlást értem, ami adott idő és hely ablak felbontással számolandó.
