...
%----------------------------------------------------------------------------
	...
	Ikezi jóslata szerint a porrészecskék sokasága
        ...
        Poros plazmák tudatos alkalmazása jelenleg leginkább
...
\centering
	\subfloat[A használt kamera.]{
		\includegraphics[width=0.7\columnwidth]{figures/camera.jpg}%
		\label{fig:cam_pic}
	}
	\\
	\subfloat[A kamera beállításainak és a képének megjelenítésére alkalmas tool.]{
		\includegraphics[width=0.7\columnwidth]{figures/vimbaviewer.png}
		\label{fig:cam_sw}
	}
...
%----------------------------------------------------------------------------
	...
	A fényképek alapján a részecskék pozíciójára és időbeli mozgására vagyunk kíváncsiak.
